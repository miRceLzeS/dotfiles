...
const vec4 TRAIL_COLOR = vec4(0.92156863, 0.73725490, 0.72941176, 1.0);
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const vec4 TRAIL_COLOR_ACCENT = vec4(0.92156863, 0.73725490, 0.72941176, 1.0);
...
const float DRAW_THRESHOLD = 0.5;
