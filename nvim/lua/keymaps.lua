...
local mappings = {
  ...
  -- window manage
  { { mode_n, mode_v }, "<Tab-h>", ":vertical resize -3<CR>", "Decrease current window width" },
  { { mode_n, mode_v }, "<Tab-j>", ":resize -3<CR>", "Decrease current window height" },
  { { mode_n, mode_v }, "<Tab-k>", ":resize +3<CR>", "Increase current window height" },
  { { mode_n, mode_v }, "<Tab-l>", ":vertical resize +3<CR>", "Increase current window width" },
  { { mode_n, mode_v }, "<Tab>sh", "<C-W>H", "Exchange current window to the left"},
  { { mode_n, mode_v }, "<Tab>sj", "<C-W>J", "Exchange current window to the bottom"},
  { { mode_n, mode_v }, "<Tab>sk", "<C-W>K", "Exchange current window to the up"},
  { { mode_n, mode_v }, "<Tab>sl", "<C-W>L", "Exchange current window to the right"},
}
